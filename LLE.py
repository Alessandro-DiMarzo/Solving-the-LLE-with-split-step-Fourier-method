...
class LLE_sim:
    ...
    def animate_slowtime(self):
        ...
        self.ani = animation.FuncAnimation(fig, update, frames=len(self.E_evolution), init_func=init, blit=False, interval=100)
...
#%%
sol.scan_detuning(-1,2.5,200,10)
